    ...
    return(
        <>
                ...
                <div className={`flex flex-col items-center w-[550px]`}>
                    ...
                    <div className="flex flex-col gap-5 w-[500px]">
                        ...
                        <div className="flex justify-between border-b pb-3">
                            ...
                            <p className="inter-500 text-black">119TL</p>
                        </div>
                        <div className="flex justify-between border-b pb-3">
            ...
            <div className="flex flex-col">
                <p className="inter-600 text-6xl text-center">Tanıtım Web Sitesi</p>
                <div className="flex items-center px-4 mt-12 justify-center">
                    <p className="inter-500 text-lg w-1/2 select-none">İşletmenizin dijital dünyada etkileyici bir ilk izlenim bırakmasını ister misiniz? Tanıtım Web Sitesi, markanızı en iyi şekilde yansıtacak modern, şık ve profesyonel bir web sitesi sunar. Müşterilerinizin sizi daha iyi tanımasını sağlarken, sunduğunuz hizmetler hakkında detaylı bilgi alabilecekleri kullanıcı dostu bir deneyim sunar.<br /><br />Tanıtım Web Sitesi Paketi, işletmelerin kurumsal kimliğini güçlendirmesi, müşteri güvenini artırması ve online görünürlüğünü sağlamlaştırması için tasarlanmıştır. Mobil uyumlu, hızlı yüklenen, SEO dostu ve şık bir tasarıma sahip olan bu paket, firmanızı en iyi şekilde temsil eder.<br /><br />Eğer siz de işletmenizi dijital dünyada profesyonel bir şekilde tanıtmak, müşterilerinizin güvenini kazanmak ve online varlığınızı güçlendirmek istiyorsanız, Seku Software’in Tanıtım Web Sitesi Paketini keşfedin! </p>
                </div>
                <div className="flex flex-col items-center px-4 mt-24 justify-center gap-5">
                    <p className="inter-600 text-4xl text-center">Neden Tanıtım Web Sitesi tercih etmelisiniz?</p>
                    <p className="inter-500 text-lg w-[800px] text-center">İşletmenizi tanıtmak ve bilgi sağlamak istiyorsanız, müşterilerinize kendinizi en iyi şekilde tanıtmak istiyorsanız; <br /> <span className="inter-600 text-3xl">bu paketi seçmelisiniz.</span></p>
                </div>
