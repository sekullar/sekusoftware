        ...
        <>
            <Modal style={customStyles} isOpen={modalOpen}>
                <div className="flex flex-col max-h-[600px]">
                    ...
                    <div className={`flex flex-col items-center sm:w-[550px] overflow-auto`}>
                        ...
                        <div className="flex flex-col gap-5 w-full sm:w-[500px] overflow-auto">
                            ...
                            <div className="flex justify-between border-b pb-3 mt-">
            ...
            <div className="flex flex-col">
                ...
                <div className={`flex flex-col mt-5 ${!cookies.darkMode ? "shadow-2xl" : "border border-gray-500"} cursor-pointer p-5 rounded-lg  hover:border-sky-200 transition-all duration-300 px-8`}>
                    <p className="inter-600 text-2xl sm:text-3xl text-center">QR Menü sitesi</p>
