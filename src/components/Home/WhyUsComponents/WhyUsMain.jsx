        ...
        <>
            <div ref={ref} className={`pt-24 select-none transition-all duration-[1.5s] ${isVisible ? "opacity-100" : "opacity-0"}`} id="whyUs">
                ...
                <div className="flex justify-around mt-10 sm:mt-20 gap-12">
                    <img loading="lazy" src={mainPhoto4} className={`xl:block hidden transition-all duration-300 ${isVisible ? "imgWhyUsAni" : "opacity-0 scale-0"}`}  alt="Some Software Icons" />
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-col sm:mt-12 mt-16  gap-20 sm:gap-12 ">
                            <div className="flex items-center sm:flex-row flex-col gap-2">
                                <img loading="lazy" src={Rocket} className={`w-[35px] ${cookies.darkMode ? "invert" : ""}`}  alt="" />
                            ...
                            <div className="flex items-center sm:flex-row flex-col gap-2">
                                <img loading="lazy" src={Diamond} className={`w-[35px] ${cookies.darkMode ? "invert" : ""}`}  alt="" />
                                <div className="flex flex-col sm:items-start items-center">
                            ...
                            <div className="flex items-center sm:flex-row flex-col gap-2">
                                <img loading="lazy" src={Fast} className={`w-[35px] ${cookies.darkMode ? "invert" : ""}`}  alt="" />
                                <div className="flex flex-col sm:items-start items-center">
                            ...
                            <div className="flex items-center sm:flex-row flex-col gap-2">
                                <img loading="lazy" src={Secure} className={`w-[35px] ${cookies.darkMode ? "invert" : ""}`}  alt="" />
                                <div className="flex flex-col sm:items-start items-center">
                            ...
                            <div className="flex items-center sm:flex-row flex-col gap-2">
                                <img loading="lazy" src={Support} className={`w-[35px] ${cookies.darkMode ? "invert" : ""}`}  alt="" />
                                <div className="flex flex-col sm:items-start items-center">
